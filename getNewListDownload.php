...
$imei=$_GET['imei'];
 ...
 //Creating sql query
 $sql = "select * from tb_list_download a where a.id_list_download NOT IN (select id_list_download from tb_proses_download where imei='".$imei."') and tanggal like CURDATE() ";
