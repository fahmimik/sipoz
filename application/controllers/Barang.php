...
class Barang extends MY_Controller 
{
	...
	public function barang_json()
	{
		...
		$fetch			= $this->m_master_ikan->fetch_data_barang($requestData['search']['value'], $requestData['order'][0]['column'], $requestData['order'][0]['dir'], $requestData['start'], $requestData['length']);
		...
		{ 
			...
			$nestedData[]	= $row['kode_ukuran_ikan'];
			$nestedData[]	= $row['ukuran_ikan'];
	...
	public function list_merek_json()
	{
		...
		{ 
			...
			$nestedData[]	= $row['nomor'];
			$nestedData[]	= $row['nama_ikan_pembelian'];
	...
	public function cek_stok()
	{
		...
		{
			$this->load->model('m_master_ikan');
			$kode = $this->input->post('kode_ukuran_ikan');
			$stok = $this->input->post('stok');

			$get_stok = $this->m_master_ikan->get_stok($kode);
