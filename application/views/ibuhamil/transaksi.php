	...
	<div class="panel panel-default">
		<div class="panel-body">
			...
			<div class='row'>
				...
				<div class='col-sm-12'>
				  <h3 style="text-align:right"><a href='<?php echo site_url('ibunifas'); ?>'>[ >>Layanan Ibu Nifas ] </a></h3>
					<h2>Form Layanan Ibu Hamil</h2>
					<form>
...
<div id='hasil_data_lama'></div>
					...
					<div class='row'>
						<div class='col-sm-8'>
							...
							<tr>
							    <td style='width:35px;'>Kehamilan Ke</td><td style='width:35px;'><select name='hamil_ke' id='hamil_ke' >
							        <?php 
							        for($a=1;$a<=15;$a++)
							        {
							    ...
							    <td style='width:35px;'>LILA</td><td style='width:35px;'><input type='text' name='lila' id='lila'> * cm <div id='rekomendasi'></div></td> </tr>
							    
								<td style='width:35px;'>Berat Badan Ibu</td><td style='width:35px;'><input type='text' name='berat' id='berat'> * kg</td> </tr>
							<tr>	<td style='width:210px;'>Umur Kehamilan</td><td style='width:35px;'><input type='text' name='umur_hamil' id='umur_kehamilan'> *minggu</td></tr>
							<tr>	<td style='width:210px;'>Pil Tambah Darah</td><td><input type='text' name='pil_darah' id='pil_darah'> * jumlah pil/tablet</td></tr>
							<tr>	<td style='width:210px;'>Status Imunisasi Tetanus</td><td><select name='imunisasi_tt' id='imunisasi_tt'><option value='Tidak'>-</option><option value='T1'>T1</option><option value='T2'>T2</option><option value='T3'>T3</option><option value='T4'>T4</option><option value='T5'>T5</option></select></td></tr>
...
function SimpanTransaksi()
{
	...
	FormData += "&umur_kehamilan="+$('#umur_kehamilan').val();
	FormData += "&vit_a="+$('#vit_a').val();
	FormData += "&pil_darah="+$('#pil_darah').val();
	FormData += "&tanggal_kunjung="+$('#tanggal_kunjung').val();
	FormData += "&imunisasi_tt="+$('#imunisasi_tt').val();
	FormData += "&catatan="+$('#catatan').val();
	FormData += "&hamil_ke="+$('#hamil_ke').val();
	FormData += "&lila="+$('#lila').val();
//	var id_master_pus = $('#id_pus').val();
//	alert(id_master_pus);
	
	$.ajax({
		url: "<?php echo site_url('ibuhamil/transaksi'); ?>",
		type: "POST",
		cache: false,
		data: FormData,
		dataType:'json',
