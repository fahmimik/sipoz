...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5 class=" col-lg-8 "><i class='fa fa-users fa-fw'></i> DAFTAR JADWAL POSYANDU</h5>
            <div><a href="<?php echo site_url('jadwal/cetak_exl')?>" class='btn btn-success pull-right' id='Cetak'><i class='fa fa-file-excel-o'></i> Cetak</a></div>
            <br/>
			<hr />
				...
				<table id="my-grid" class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th  style='text-align:center'>Tgl Posyandu </th>
							<th  style='text-align:center'>Waktu Posyandu</th>
...
<?php
$tambahan = nbs(2)."<a href='".site_url('jadwal/tambah')."' class='btn btn-default' id='TambahUser'><i class='fa fa-plus fa-fw'></i> Tambah Data</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('jadwal/jadwal-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
