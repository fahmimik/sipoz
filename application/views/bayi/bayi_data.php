...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5 class=" col-lg-8 "><i class='fa fa-users fa-fw'></i> DATA BAYI & BALITA</h5>
            <div><a href="<?php echo site_url('Bayi/cetak_exl')?>" class='btn btn-success pull-right' id='Cetak'><i class='fa fa-file-excel-o'></i> Cetak</a></div>
			<br/>
			<hr />
				...
				<table id="my-grid" class="table table-striped table-bordered">
					<thead>
						<tr>
							...
							<th style='text-align:center'>Grafik Berat</th>
							<th style='text-align:center'>Imunisasi</th>
							<th class='no-sort' style='text-align:center'>Edit</th>
							<th class='no-sort' style='text-align:center'>Hapus</th>
						</tr>
					</thead>
				</table>
			</div>
...
<?php
$tambahan = nbs(2)."<a href='".site_url('bayi/tambah')."' class='btn btn-default' id='TambahUser'><i class='fa fa-plus fa-fw'></i> Tambah BAYI / BALITA Baru</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"ajax":{
				url :"<?php echo site_url('bayi/bayi-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
