...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5 class=" col-lg-8 "><i class='fa fa-users fa-fw'></i> DAFTAR BANTUAN</h5>
            <div><a href="<?php echo site_url('bantuan/cetak_exl')?>" class='btn btn-success pull-right' id='Cetak'><i class='fa fa-file-excel-o'></i> Cetak</a></div>
			<hr />
...
<?php
$tambahan = nbs(2)."<a href='".site_url('bantuan/tambah')."' class='btn btn-default' id='TambahUser'><i class='fa fa-plus fa-fw'></i> Tambah Data</a>";
	...
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"oLanguage": {
				...
				"sbantuan": "Menampilkan _START_ s/d _END_ dari <b>_TOTAL_ data</b>",
				"sbantuanFiltered": "(difilter dari _MAX_ total data)", 
			...
			"ajax":{
				url :"<?php echo site_url('bantuan/bantuan-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
