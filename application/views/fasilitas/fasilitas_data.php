...
<div class="container">
	<div class="panel panel-default">
		<div class="panel-body">
			<h5 class=" col-lg-8 "><i class='fa fa-users fa-fw'></i> DAFTAR FASILITAS KESEHATAN</h5>
            <div><a href="<?php echo site_url('fasilitas/cetak_exl')?>" class='btn btn-success pull-right' id='Cetak'><i class='fa fa-file-excel-o'></i> Cetak</a></div>
            <br/>
			<hr />
...
<?php
$tambahan = nbs(2)."<a href='".site_url('fasilitas/tambah')."' class='btn btn-default' id='TambahUser'><i class='fa fa-plus fa-fw'></i> Tambah Data</a>";
...
<script type="text/javascript" language="javascript" >
	$(document).ready(function() {
		var dataTable = $('#my-grid').DataTable( {
			...
			"oLanguage": {
				...
				"sfasilitas": "Menampilkan _START_ s/d _END_ dari <b>_TOTAL_ data</b>",
				"sfasilitasFiltered": "(difilter dari _MAX_ total data)", 
			...
			"ajax":{
				url :"<?php echo site_url('fasilitas/fasilitas-json'); ?>",
				type: "post",
				error: function(){ 
					$(".my-grid-error").html("");
	...
	$(document).on('click', '#TambahUser, #EditUser', function(e){
		...
		if($(this).attr('id') == 'EditUser')
		{
			$('.modal-dialog').removeClass('modal-lg');
			$('.modal-dialog').removeClass('modal-sm');
			$('#ModalHeader').html('Edit Fasilitas');
		}
