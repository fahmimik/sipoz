...
//Setingan Database
$config['database_host']	= '157.245.152.9';
$config['database_user']	= 'fahmi_amrullah';
$config['database_pass'] 	= 'DFQt3}^M!tYM';
$config['database_name']	= 'fahmi_db_sipos';
...
$config['web_title']		= "SIM-SIPTER POSYANDU";
